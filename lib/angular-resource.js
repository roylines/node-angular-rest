...
var resource = function(app, root, name, middleware) {
	var r = require(path.join(path.dirname(module.parent.filename), basePath, name));
	var uri = root + '/' + name;
	var iduri = uri + '/:id';
...
var init = function(initialBasePath) {
	if (initialBasePath) {
